...
$(document).ready(function () {
  ...
  /**********************
   **********************
     STICK ON TO THE ELEMENT (MAP ELEMENT)
   **********************
   **********************/
  var element1 = document.querySelector('.location__info');
  var element2 = document.querySelector('.location__img');

  // Function to make element2 stick to element1
  ...
  **********************/
  ...
  async function initMap() {
    ...
    /* const forReal = { lat: 41.314019, lng: 69.250495 } */

    map = new Map(document.getElementById("map"), {
      center: { lat: 41.314015, lng: 69.249096 },
      zoom: 18,
      disableDefaultUI: true,
    });

    var marker = new google.maps.Marker({
      position: { lat: 41.314015, lng: 69.249096 },
    });
